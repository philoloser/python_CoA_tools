...
sciezka_dest = r"C:\Users\i.janowska\Torf Corporation Sp. z o.o\KJ - _Sharepoint_TC\QC kontrola jakosci\surowce\Certyfikaty\certyfikaty_wg_lat\certyfikaty_2024"
...
while cont == 1:
    ...
    while cont == 1:
        ...
        if gk_b == "1":  # nasze gk
            ...
            path = r"C:\Users\i.janowska\Torf Corporation Sp. z o.o\DZIAŁ ZAKUPÓW - Zalaczniki do CHECK LISTY" + "\\" + cdn
