...
coa_dir_path = os.path.realpath(os.path.join(r'c:\Users\i.janowska\OneDrive - Torf Corporation Sp. z o.o\_Sharepoint_TC\QC kontrola jakosci\surowce\Certyfikaty\certyfikaty_wg_lat', coa_dir_name))
